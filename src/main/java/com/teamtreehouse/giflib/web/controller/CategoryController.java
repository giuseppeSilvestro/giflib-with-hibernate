...
public class CategoryController {
    ...
    public String listCategories(Model model) {
        ...
        /*
        the next commented lines are the implementation if we do not use the DAO and Service packages
        that we have just coded. If you want to use them, move the @Autowired outside the method.
         */
//        @Autowired
    ...
    public String updateCategory(@Valid Category category, BindingResult result, RedirectAttributes redirectAttributes) {
        ...
        if (result.hasErrors()) {
            ...
            redirectAttributes.addFlashAttribute("flash",
                    new FlashMessage("Category not updated... Please follow the instructions", FlashMessage.Status.FAILURE));
